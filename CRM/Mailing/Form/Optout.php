...
class CRM_Mailing_Form_Optout extends CRM_Core_Form {
  ...
  public function buildQuickForm() {
    ...
    $this->setTitle(ts('Potwierdź prośbę o rezygnację ze wszystkich wysyłek'));
  ...
  public function postProcess() {
    ...
    $statusMsg = sprintf('Adres e-mail: %s został prawidłowy wypisany ze wszystkich wysyłek', [1 => CRM_Utils_String::maskEmail($this->_email)]);

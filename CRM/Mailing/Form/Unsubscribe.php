...
class CRM_Mailing_Form_Unsubscribe extends CRM_Core_Form {
  ...
  public function preProcess() {
    ...
    if (!$groupExist && !$isConfirm) {
      $statusMsg = sprintf('Adres e-mail %s został już wcześniej prawidłowy wypisany z newslettera.', $email);
  ...
  public function postProcess() {
    ...
    $statusMsg = sprintf('Adres e-mail: %s został wypisany z newslettera.', $this->_email);
